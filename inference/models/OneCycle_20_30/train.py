...
def main():
    ...
    trainer.start(num_epochs=config.H_PARAMS["TOTAL_EPOCH"], resume=True, sort=True, checkpoint_name="checkpoint_epoch_20_train_1.7259.pth", total_steps=total_steps)
